...
contract('EventManager', function(accounts) {
  it('should do stuff', function() {
    return EventManager.deployed().then((_terrapin) => {
      // return new Promise((resolve, reject) => {
      terrapin = _terrapin;
      return terrapin.createEvent(
        'Bunburry',
        'concert',
        '372 Main Avn. Cinci Ohio',
        1494900246799,
        1494900256799,
        {
          from: accounts[0],
      ...
      return terrapin.getEvents.call();
    }).then((eventAddresses) => {
      var eventInstance = Event.at(eventAddresses[0]);
      return eventInstance.owner.call().then(console.log);
    })
    .catch(console.log);
  });
